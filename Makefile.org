...
files:
	$(PERL) $(TOP)/util/files.pl configure.mk Makefile > $(TOP)/MINFO
...
gentests:
	...
	$(MAKE) -e $(BUILDENV) TESTS='$(TESTS)' OPENSSL_DEBUG_MEMORY=on generate );
...
tests: rehash
	...
	$(MAKE) -e $(BUILDENV) TOP=.. TESTS='$(TESTS)' OPENSSL_DEBUG_MEMORY=on OPENSSL_CONF=../apps/openssl.cnf tests );

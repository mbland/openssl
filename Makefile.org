...
files:
	$(PERL) $(TOP)/util/files.pl TOP=$(TOP) configure.mk Makefile > $(TOP)/MINFO
...
gentests:
	...
	$(MAKE) TESTS='$(TESTS)' OPENSSL_DEBUG_MEMORY=on generate );
...
tests: rehash
	...
	$(MAKE) TOP=.. TESTS='$(TESTS)' OPENSSL_DEBUG_MEMORY=on OPENSSL_CONF=../apps/openssl.cnf tests );
...
dist_pem_h:
	(cd crypto/pem; $(MAKE) pem.h; $(MAKE) clean)
